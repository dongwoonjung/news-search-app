  ...
  try {
    ...
    if (company) {
      ...
      const categoryQueries = {
        ...
        'automotive': '("auto industry" OR "car industry" OR "car maker" OR "car manufacturer" OR "automotive industry" OR "vehicle manufacturer") OR (Toyota OR Honda OR Ford OR GM OR Tesla OR Volkswagen OR Hyundai OR Kia OR BMW OR Mercedes OR Nissan) AND (sales OR production OR market OR earnings OR revenue OR factory OR plant OR EV OR electric OR strategy OR competition)',
